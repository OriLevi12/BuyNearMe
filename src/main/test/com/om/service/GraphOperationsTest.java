...
public class GraphOperationsTest {
    ...
    private static class TestDao implements com.om.dao.IDao {
        ...
        public TestDao() {
            ...
            // Initialize with modifiable lists
            edges.put("A", new java.util.ArrayList<>());
            edges.put("B", new java.util.ArrayList<>());
            edges.put("C", new java.util.ArrayList<>());
            edges.put("D", new java.util.ArrayList<>());
            
            // Add the initial edges
            edges.get("A").add(new Edge("A", "B", 1.5));
            edges.get("A").add(new Edge("A", "D", 2.0));
            edges.get("B").add(new Edge("B", "A", 1.5));
            edges.get("B").add(new Edge("B", "C", 1.0));
            edges.get("C").add(new Edge("C", "B", 1.0));
            edges.get("C").add(new Edge("C", "D", 1.5));
            edges.get("D").add(new Edge("D", "A", 2.0));
            edges.get("D").add(new Edge("D", "C", 1.5));
        }
